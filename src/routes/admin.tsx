...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [{ title: "Admin Panel — PassAssist" }],
  }),
  component: AdminPage,
});
...
function AdminPage() {
  ...
  const DEFAULT_PAGES_CONTENT = {
    ...
    portfolio: `# Creator Portfolio\n\nWelcome! I am the creator and developer of PassAssist.\n\n## Profile\n- **Name**: Alex Johnson\n- **Role**: Founder & Lead Developer\n- **Email**: contact@prepai.com\n- **Socials**: [GitHub](https://github.com) | [LinkedIn](https://linkedin.com)\n\n## Background\nI am a passionate software engineer specializing in AI applications and modern web technologies. I built PassAssist to help students prepare for IELTS, TOEFL, and TOEIC exams in an interactive, cost-effective way.\n\n## Technologies\n- **Frontend**: React, TypeScript, TanStack Router, TailwindCSS\n- **Backend**: Supabase, PostgreSQL, Edge Functions\n- **AI Integrations**: Gemini API, Web Audio API analysis\n- **Styling**: Vanilla CSS, Tailwind v4\n\n## PassAssist Project\nPassAssist leverages cutting-edge natural language processing to grade essays and evaluate speaking response pronunciation instantly. My goal is to make premium tutoring accessible to everyone, everywhere.`,
  };
  ...
  const [aiMessages, setAiMessages] = useState<{ role: "user" | "assistant"; text: string }[]>([
    {
      role: "assistant",
      text: "Hello! I am your PassAssist Admin Assistant. How can I help you manage your course materials, write descriptions, or organize outline chapters today?",
    },
  ]);
                ...
                {isAiTyping && (
                  <div className="flex justify-start">
                    <div className="bg-muted/80 border border-border rounded-2xl rounded-tl-none px-4 py-2.5 text-sm text-muted-foreground flex items-center gap-2">
                      ...
                      <span>PassAssist Helper is thinking...</span>
                    </div>
                  </div>
                )}
              </div>

...
function AuthPage() {
  ...
  // Password reset/forgot password states
  ...
  // Initialize resetEmail with whatever they typed in signInEmail
  useEffect(() => {
    if (isForgotPassword && signInEmail) {
      setResetEmail(signInEmail);
    }
  }, [isForgotPassword]);

  // Listen for recovery email URL hash/search redirect and auth state events
  useEffect(() => {
          ...
          {isResettingPassword ? (
            <div className="animate-fade-in">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-extrabold tracking-tight font-heading text-foreground">Update Password</h2>
              ...
              <form onSubmit={handleUpdatePassword} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="new-password" className="text-[10px] font-extrabold uppercase tracking-wider text-muted-foreground/85">
                    New Password
                  </Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="confirm-password" className="text-[10px] font-extrabold uppercase tracking-wider text-muted-foreground/85">
                    Confirm Password
                  </Label>
                  <div className="relative">
                    <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 size-4 text-muted-foreground/60" />
                ...
                >
                  {loading ? (
                    ...
                    <>
                      Update Password <ArrowRight className="size-4 ml-1.5" />
                    </>
                  )}
                </Button>
              </form>
            ...
            <div className="animate-fade-in">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-extrabold tracking-tight font-heading text-foreground">Reset Password</h2>
                <p className="text-xs text-muted-foreground mt-1.5 leading-relaxed">
              ...
              <form onSubmit={handleSendResetLink} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="reset-email" className="text-[10px] font-extrabold uppercase tracking-wider text-muted-foreground/85">
                    Email address
                  </Label>
                  <div className="relative">
                ...
                <Button
                  ...
                  className="w-full rounded-xl h-10.5 font-bold text-muted-foreground hover:text-foreground hover:bg-muted/40 cursor-pointer"
                  disabled={loading}
                >
                  Back to Sign In
                </Button>
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="text-[10px] font-bold text-accent hover:underline cursor-pointer focus:outline-none"
                        >
                          Forgot password?
                        </button>
                      </div>
